...
func main() {
	...
	flag.StringVar(&storagePath, "storage-path", "E:/prim/Arifmetic_Server/storage/storage.db", "Path to the storage directory")
	flag.StringVar(&migrationPath, "migration-path", "E:/prim/Arifmetic_Server/migration", "Path to the migration directory")
